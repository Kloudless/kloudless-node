...
function Kloudless(key) {
    ...
    Kloudless.files.uploadMultipart = function(account_id, parent_id, file, name, session_id, offset) {
      return new MultipartUpload(account_id, parent_id, file, name, session_id, offset);
    };
    Kloudless.files.stopMultipart = MultipartUpload.stopSession;
}
